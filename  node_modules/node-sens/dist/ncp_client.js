...
var NCPClient = /** @class */ (function () {
    ...
    NCPClient.prototype.sendSMS = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _c, timestamp, signature, response, error_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                        _c = this.prepareSignature(), timestamp = _c.timestamp, signature = _c.signature;
     ...
     */
    NCPClient.prototype.prepareSignature = function () {
        var space = ' ';
        var newLine = '\n';
        var message = [];
